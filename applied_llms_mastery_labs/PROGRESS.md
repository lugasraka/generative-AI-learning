...
- [ ] **Part 3** — Prompting & Prompt Engineering — `prompt_engineering_lab.py`
- [ ] **Part 4** — Fine-Tuning LLMs — `finetuning_comparison.py`
- [ ] **Part 5** — Retrieval-Augmented Generation — `rag_pipeline.py`
